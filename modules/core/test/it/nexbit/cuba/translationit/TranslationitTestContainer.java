package it.nexbit.cuba.translationit;
...
public class TranslationitTestContainer extends TestContainer {

    public TranslationitTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "it/nexbit/cuba/translationit/app.properties",
    ...
    public static class Common extends TranslationitTestContainer {

        public static final TranslationitTestContainer.Common INSTANCE = new TranslationitTestContainer.Common();
